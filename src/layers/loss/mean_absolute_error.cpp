...
void mean_absolute_error_layer<TensorDataType, T_layout, Dev>::local_fp_compute() {
  ...
  CALI_MARK_BEGIN("mean_absolute_error_layer::local_fp_compute");
#endif
...
#ifdef LBANN_HAS_CALIPER
  CALI_MARK_END("mean_absolute_error_layer::local_fp_compute");
#endif
}
...
#ifdef LBANN_HAS_CALIPER
  CALI_MARK_BEGIN("mean_absolute_error_layer::local_bp_compute");
#endif
...
#ifdef LBANN_HAS_CALIPER
  CALI_MARK_END("mean_absolute_error_layer::local_bp_compute");
#endif
}
